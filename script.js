$(document).ready(function() {
  ...
  var TITLE = 'LAP's English Learners by Select School Districts in CT, 2018-19';
  ...
  var X_AXIS = 'School Districts2';

  // y-axis label, label in tooltip
  var Y_AXIS = 'Number of Enrolled Students2';
